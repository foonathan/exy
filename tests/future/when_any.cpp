...
TEST_CASE("when_any", "[futures]")
{
    ...
    CHECK_FUTURE(error_value, exy::error_tag(), -1);
    ...
    CHECK_FUTURE(stop_value, exy::value_tag(), 0);
    ...
    CHECK_FUTURE(exy_mov(throwing_move), exy::value_tag(), 0);
    ...
    CHECK_FUTURE(stop_on_error, exy::error_tag(), 0);
    ...
    CHECK_FUTURE(stop_on_stopped, exy::stopped_tag());
}
